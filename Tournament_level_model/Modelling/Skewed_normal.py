...
with pm.Model() as model:
    ...
    skew_golfer = pm.Uniform('skew_golfer',lower=-2, upper=10,shape=num_golfers)
    
    # Observed scores to par follow Skew normal distribution
    golfer_to_par = pm.SkewNormal("golfer_to_par", alpha=skew_golfer[observed_golfers_shared], mu=mean_golfer[observed_golfers_shared], sigma=sd_golfer[observed_golfers_shared], observed=observed_round_score)
